...
app.post("/homereg", (request, response) => {
  ...
  let query =
    "INSERT INTO homereg(name,age,mobile,verification_id,id_no,pincode,address,reason) VALUES($1,$2,$3,$4,$5,$6,$7,$8) RETURNING *";
  let values = [
    user.name,
    user.age,
    user.mobile,
...
app.post("/basicreg", (request, response) => {
  ...
  let query =
    "INSERT INTO basicreg(name,age,mobile,verification_id,id_no,pincode,van_address) VALUES($1,$2,$3,$4,$5,$6,$7) RETURNING id_no";
  let values = [
    user.name,
    user.age,
    user.mobile,
