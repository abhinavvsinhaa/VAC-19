...
class Availabile extends React.Component {
  constructor() {
    ...
    //NO NEED TO USE BIND FOR ARROW FUNCTIONS
  ...
  onSubmit = (event) => {
    ...
    fetch(
      `http://localhost:8080/?pincode=${this.state.pincode}`,
      requestOptions
    )
      ...
      <div className="container find">
        ...
        <div className="row justify-content-center">
          <div className="col-xl-6 col-lg-6 col-md-8 col-sm-12 col-12">
            <p id="enterpin">
              Enter your pincode to find mobile vans in different localities
              near you.
            </p>
            <form className="row" onSubmit={this.onSubmit}>
              ...
              <div className="col-md-3 col-lg-3 col-xl-3 col-sm-3 col-3">
                <button type="submit" className="btn btn-dark findBtn">
                  Find
                </button>
              </div>
            </form>
          ...
          <div className="col-xl-6 col-lg-6 col-md-8 col-sm-12 col-12">
            ...
            {this.state.vans.map((v) => {
              return (
                <>
                  <div class="card">
                    <div class="card-header">Van {v.sno}</div>
                    <div class="card-body">
                      <p class="card-text">
                        {v.address}
